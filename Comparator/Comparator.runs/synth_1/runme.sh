...
HD_PWD='D:/Verilog Projects/Comparator/Comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comp4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comp4bit.tcl
