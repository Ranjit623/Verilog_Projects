...
HD_PWD='D:/Verilog Projects/Multiplexer/Multiplexer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux16.tcl
