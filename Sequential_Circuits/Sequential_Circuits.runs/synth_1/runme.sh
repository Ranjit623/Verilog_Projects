...
HD_PWD='D:/Verilog Projects/Sequential_Circuits/Sequential_Circuits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StatFlag.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StatFlag.tcl
