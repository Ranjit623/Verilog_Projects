...
HD_PWD='D:/Verilog Projects/Flip-flop/Flip-flop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Flipflop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Flipflop.tcl
