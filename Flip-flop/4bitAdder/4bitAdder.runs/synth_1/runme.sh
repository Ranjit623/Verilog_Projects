...
HD_PWD='D:/Verilog Projects/4bitAdder/4bitAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AddSub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AddSub.tcl
