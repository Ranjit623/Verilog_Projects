...
HD_PWD='D:/Verilog Projects/2level_comb/2level_comb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Circuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Circuit.tcl
