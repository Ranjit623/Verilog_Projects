...
HD_PWD='D:/Verilog Projects/Flip-flops/Flip-flops.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKFF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JKFF.tcl
