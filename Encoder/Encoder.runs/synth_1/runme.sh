...
HD_PWD='D:/Verilog Projects/Encoder/Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Enc83.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Enc83.tcl
