...
HD_PWD='D:/Verilog Projects/Full_Adder/Full_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FAdder.tcl
