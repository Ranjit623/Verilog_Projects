...
HD_PWD='D:/Verilog Projects/Decoder/Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dec38.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dec38.tcl
