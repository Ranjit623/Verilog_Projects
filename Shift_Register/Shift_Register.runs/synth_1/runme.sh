...
HD_PWD='D:/Verilog Projects/Shift_Register/Shift_Register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SISO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SISO.tcl
