...
HD_PWD='D:/Verilog Projects/Counter/Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count.tcl
